...
class Token: public RefCount
    ...
    public:
        ...
        //      **********  functions   **********
                    ...
                    explicit                Token           (TokenType, NumberType);
                                            ~Token          ();
                    Token &                 Build           ();
    ...
    private:
        ...
        //  **********  functions   **********
            ...
            static  TokenState              FinishedBadToken(Token &);
...
inline Token::Token (TokenType NewType, NumberType NewValue)
    {
...
inline void Token::Init (TokenType T, int V = 0)
    {
    Type = T;
    Value = V;
    }
